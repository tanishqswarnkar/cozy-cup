    ...
    <div className="min-h-screen bg-[#FCFAF6] flex flex-col justify-between pt-8 sm:pt-12 px-4 sm:px-10 md:px-16 animate-fadeIn">
      <div className="max-w-7xl mx-auto w-full pb-24">
        ...
        <motion.div
          ...
          className="border-b border-[#201B15]/15 pb-10 mb-12 text-center max-w-3xl mx-auto"
        >
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 sm:gap-16 items-start">
          ...
          <div className="lg:col-span-5 space-y-6">
            <div className="bg-white p-7 rounded-3xl border border-[#201B15]/10 shadow-sm space-y-6">
              <h3 className="font-display font-bold text-2xl text-[#201B15] border-b border-[#201B15]/10 pb-3">
                Flagship Roastery Info
              </h3>

              <div className="flex items-start gap-4">
                <div className="w-11 h-11 rounded-2xl bg-amber-100 text-amber-900 flex items-center justify-center text-xl shrink-0">
                  📍
                </div>
                <div>
                  <h4 className="font-display font-bold text-base text-[#201B15]">Visit Our Sanctuary</h4>
                  <p className="text-xs sm:text-sm text-[#201B15]/70 mt-0.5 leading-relaxed">
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  <h4 className="font-display font-bold text-base text-[#201B15]">Phone & Reservations</h4>
                  <p className="text-xs sm:text-sm text-[#201B15]/70 mt-0.5">
                    +1 (555) 234-COZY (2699)<br />
                    <span className="text-[11px] text-[#201B15]/50">Available Mon-Sun during opening hours</span>
                  </p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  <h4 className="font-display font-bold text-base text-[#201B15]">Email & Wholesale</h4>
                  <p className="text-xs sm:text-sm text-[#201B15]/70 mt-0.5">
            ...
            <div className="bg-[#201B15] text-[#FCFAF6] p-7 rounded-3xl shadow-xl border border-amber-500/20">
          ...
          <div className="lg:col-span-7 bg-white p-8 sm:p-12 rounded-3xl border border-[#201B15]/15 shadow-lg">
            <h3 className="font-display font-bold text-3xl text-[#201B15] mb-2">
              Send Our Team a Message
            </h3>
            <p className="text-xs sm:text-sm text-[#201B15]/65 mb-8">
              Fill out the form below and a Q-Grader or store manager will reply directly within 24 business hours.
            </p>

            {submitted ? (
              <div className="py-16 text-center bg-emerald-50 rounded-2xl border border-emerald-200 p-8 animate-fadeIn">
                ...
                <h4 className="font-display font-bold text-2xl text-emerald-900">Inquiry Received!</h4>
              ...
              <form onSubmit={handleSubmit} className="space-y-5">
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
                  <div>
                    <label className="block text-xs font-semibold text-[#201B15]/80 mb-2">
                      Your Full Name *
                    </label>
                    <input
                      required
                      ...
                      className="w-full bg-[#FCFAF6] border border-[#201B15]/20 rounded-xl px-4 py-3.5 text-sm text-[#201B15] focus:outline-none focus:border-[#201B15] transition-colors"
                    />
                  </div>
                  <div>
                    <label className="block text-xs font-semibold text-[#201B15]/80 mb-2">
